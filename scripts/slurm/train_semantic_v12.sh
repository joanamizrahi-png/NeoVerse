...
mkdir -p /scratch/m000204-pm06b/joana/runs/train_semantic_v12
...
grep -q "rgb_preservation_weight: 1.0" training/configs/train_semantic_v12.yaml && grep -q "snr_gamma: 5.0" training/configs/train_semantic_v12.yaml && grep -q "semantic_ce_sigma_max: 1.0" training/configs/train_semantic_v12.yaml \
    || { echo "[sanity] FATAL: v10 config missing the v12 knobs"; exit 1; }

python train.py training/configs/train_semantic_v12.yaml

echo "==> v12 run done; checkpoints in /scratch/m000204-pm06b/joana/runs/train_semantic_v12/"
