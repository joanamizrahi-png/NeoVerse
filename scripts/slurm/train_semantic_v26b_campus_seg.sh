...
grep -q "sanpo_v26" training/configs/train_semantic_v26b_campus_seg.yaml \
...
python train.py training/configs/train_semantic_v26b_campus_seg.yaml
echo "==> v26_campus done; checkpoints in /scratch/m000204-pm06b/joana/runs/train_semantic_v26b_campus_seg/"
