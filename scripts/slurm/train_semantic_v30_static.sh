#!/usr/bin/env bash
#SBATCH --job-name=train-sem-v30_static
...
#SBATCH --output=/scratch/m000204-pm06b/joana/slurm-train-sem-v30_static-%j.out
#SBATCH --error=/scratch/m000204-pm06b/joana/slurm-train-sem-v30_static-%j.err

# v30_static: v26's recipe warm-started from v26 e10 with STATIC training
# reconstruction (dense conditioning rasters). See the config header.

set -euo pipefail
mkdir -p /scratch/m000204-pm06b/joana/runs/train_semantic_v30_static
...
grep -q "sanpo_v26" training/configs/train_semantic_v30_static.yaml \
    || { echo "[sanity] FATAL: config not pointing at the v26 roots"; exit 1; }
grep -q "static_scene=True" training/configs/train_semantic_v30_static.yaml \
...
python train.py training/configs/train_semantic_v30_static.yaml
echo "==> v30_static done; checkpoints in /scratch/m000204-pm06b/joana/runs/train_semantic_v30_static/"
