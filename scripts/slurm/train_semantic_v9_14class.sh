#!/usr/bin/env bash
#SBATCH --job-name=train-sem-v9-14class
...
mkdir -p /scratch/m000204-pm06b/joana/runs/train_semantic_v9_14class
...
grep -q "semantic_x0_prediction: true" training/configs/train_semantic_v9_14class.yaml && grep -q "num_semantic_classes: 14" training/configs/train_semantic_v9_14class.yaml && grep -q "sam3_labels_v14" training/configs/train_semantic_v9_14class.yaml && grep -q "segments_dir" training/configs/train_semantic_v9_14class.yaml \
    || { echo "[sanity] FATAL: smoke config missing semantic_x0_prediction: true"; exit 1; }

python train.py training/configs/train_semantic_v9_14class.yaml

echo "==> v8 smoke done; checkpoints in /scratch/m000204-pm06b/joana/runs/train_semantic_v9_14class/"
